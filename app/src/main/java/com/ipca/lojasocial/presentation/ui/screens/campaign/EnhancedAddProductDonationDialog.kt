...
/**
 * ✅ Dialog MELHORADO para adicionar doações de produtos
 * Agora com quantidade, unidade e categoria para adicionar ao inventário
 */
@OptIn(ExperimentalMaterial3Api::class)
@Composable
fun EnhancedAddProductDonationDialog(
    onConfirm: (
        productName: String,
        quantity: Double,
        unit: ProductUnit,
